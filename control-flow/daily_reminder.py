...
match priority:
    ...
    case "high":
        if time_bound == "no":
            print(
                f"Note: '{task}' is a high priority task. Consider completing it when you have free time"
            )
            exit()
    case "medium":
        if time_bound == "no":
            print(
                f"Note: '{task}' is a medium priority task. Consider completing it when you have free time"
            )
            exit()
    case "low":
        if time_bound == "no":
